      ...
      <div className="grid grid-cols-2 gap-2 p-1 bg-blue-50 rounded-lg">
        <button
          ...
          className={
            ...
            (role === ROLE.STUDENT ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:text-gray-900')
          }
        >
        ...
        <button
          ...
          className={
            'flex items-center justify-center gap-2 py-3 px-4 rounded-lg transition-all ' +
            (role === ROLE.MENTOR ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:text-gray-900')
          }
        >
